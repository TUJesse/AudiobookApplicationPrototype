...
public class LittleRedRidingHoodBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_little_red_riding_hood_book);
        ...
        sounds = new int[] {R.raw.little_red_riding_hood_page1, R.raw.little_red_riding_hood_page2,
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                soundTest.stop();
                soundTest = MediaPlayer.create(LittleRedRidingHoodBook.this,sounds[current_index]);
            }
        });
        ...
        documentReference.set(bookmark).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Utility.showToast(LittleRedRidingHoodBook.this,"Bookmark added successfully");
                }else {
                    Utility.showToast(LittleRedRidingHoodBook.this,"Bookmark failed");
