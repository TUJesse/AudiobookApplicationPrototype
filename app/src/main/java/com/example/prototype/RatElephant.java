...
public class RatElephant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rat_elephant);
        ...
        sounds = new int[] {R.raw.rat_elephant_page_1, R.raw.rat_elephant_page_2,
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                soundTest.stop();
                soundTest = MediaPlayer.create(RatElephant.this,sounds[current_index]);
            }
        });
        ...
        documentReference.set(bookmark).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Utility.showToast(RatElephant.this,"Bookmark added successfully");
                }else {
                    Utility.showToast(RatElephant.this,"Bookmark failed");
