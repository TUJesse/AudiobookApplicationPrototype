...
public class TheFoxAndTheCrow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_fox_and_the_crow);
        ...
        sounds = new int[] {R.raw.fox_crow_page_1, R.raw.fox_crow_page_2,
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                soundTest.stop();
                soundTest = MediaPlayer.create(TheFoxAndTheCrow.this,sounds[current_index]);
            }
        });
        ...
        documentReference.set(bookmark).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Utility.showToast(TheFoxAndTheCrow.this,"Bookmark added successfully");
                }else {
                    Utility.showToast(TheFoxAndTheCrow.this,"Bookmark failed");
