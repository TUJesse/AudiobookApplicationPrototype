...
public class Cinderella extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pages = new int[] {page1, page2, page3, page4, page5, page6, page7, page8};
        ...
        sounds = new int[] {R.raw.cinderella_page_1, R.raw.cinderella_page_2,
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                soundTest.stop();
                soundTest = MediaPlayer.create(Cinderella.this,sounds[current_index]);
            }
        });
        ...
        documentReference.set(bookmark).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Utility.showToast(Cinderella.this,"Bookmark added successfully");
                }else {
                    Utility.showToast(Cinderella.this,"Bookmark failed");
